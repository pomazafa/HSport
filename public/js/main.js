...
if($('.brands-cards').length > 0 ) {
	$('.brands-cards').slick({
		...
		//appendDots:
		//appendArrows:$('.mainslider-arrows .container'),
		prevArrow: '<button type="button" class="slick-prev blue-arrow"></button>',
...
function map(n){
	...
	var locations = [
		[new google.maps.LatLng(55.6819335,37.6283635)],
...
// Menu adress
$('.header__addresses').click(function () {
	$('.header__address').slideToggle(200);
...
// Menu Burger
$('.header__burger, .sub-header__menu-item').click(function (event) {
	if ($(window).width() < 992) {
		$('.header__burger, .header-curtain').toggleClass('active');
